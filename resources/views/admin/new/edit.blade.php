            ...
            <div class="col-md-10">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <div class="row">
                              <div class="col-md-6">
                                <h3 class="card-title">Edit News and Event</h3>
                              </div>
                        ...
                        <form action="{{route('newsUpdate',$latest->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="form-group">
                                <input class="form-control" value="{{$latest->title}}" name="title" placeholder="Title">
                                </div>
                                <div class="div" style="margin-bottom: 10px;">
                                    <img style="width: 100px" src="{{asset($latest->image)}}" alt=""/>
                                </div>
                                <div class="form-group">
                                    <input type="file" name="image">
                                </div>
                                <div class="form-group">
                                    <textarea id="compose-textarea" name="description" value="{{$latest->description}}" class="form-control" style="height: 300px">
                                        {!!$latest->description !!}
                                    </textarea>
                                </div>
                            </div>
