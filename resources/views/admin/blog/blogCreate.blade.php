    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row justify-content-center">
          <!-- /.col -->
            <div class="col-md-10">
                <form action="{{route('blogPublish')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <input class="form-control" name="blogTitle" placeholder="Title:">
                            </div>
                            <div class="form-group">
                            <input type="file" name="blogImage">
                            </div>
                            <div class="form-group">
                                <textarea id="compose-textarea" name="blogCompose" class="form-control" style="height: 300px">
